...
extern "C" void write_x1(std::uint64_t iterations, std::uint8_t* buffer);
extern "C" void write_x2(std::uint64_t iterations, std::uint8_t* buffer);
extern "C" void write_x3(std::uint64_t iterations, std::uint8_t* buffer);
extern "C" void write_x4(std::uint64_t iterations, std::uint8_t* buffer);
